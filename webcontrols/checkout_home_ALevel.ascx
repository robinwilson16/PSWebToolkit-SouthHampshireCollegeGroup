<%@ Control Language="VB" AutoEventWireup="false" CodeFile="checkout_home_ALevel.ascx.vb" Inherits="checkout_home_ALevel"  %>
...
<br />
 ...
 <div class="form-field-section grey">
         ...
         <h2 class="app-title">Welcome to SHCG A Level Online Applications</h2>


        <p class="alert alert-info"><b>Note : You must be aged 16 or above on the 31st August of the start year of your course</b></p>
     ...
     <h3>Your choices</h3>
        ...
        <p class="alert alert-info">Please select 2 additional A Level subjects. You can add more if you are unsure of your final choice at this stage. A decision on the 3 A Levels you will be studying can be discussed at enrolment. </p>
    ...
    <p class="textfieldlabelrequired">Additional choice 1</p>
    <asp:DropDownList ID="CourseChoice1" runat="server" CssClass="form-control">


    </asp:DropDownList>
    <br />
    
    <p class="textfieldlabelrequired">Additional choice 2</p>
    <asp:DropDownList ID="CourseChoice2" runat="server" CssClass="form-control">
    ...
    <p class="textfieldlabel">Additional choice 3</p>
    <asp:DropDownList ID="CourseChoice3" runat="server" CssClass="form-control">


    </asp:DropDownList>
       <br />
    <p class="textfieldlabel">Additional choice 4</p>
    <asp:DropDownList ID="CourseChoice4" runat="server" CssClass="form-control">
...
<%--      <p><b>If you want to remove any item from the basket you can do so below</b></p>--%>
 ...
 <asp:PlaceHolder runat="server" ID="BasketPlaceHolder" Visible="false">
  ...
  <%--   <p class="alert alert-info">This web form will remain open for up to 3 hours to allow you to complete your application / enrolment.</p>--%>
     ...
     <asp:Button ID="btnSearch" runat="server" CssClass="button secondary" Text="Search for more courses" Visible="false" />
    ...
    <div class="form-input">
      ...
      <div class=" form-group">
        <cc1:StudentEnrolmentField ID="datepicker" runat="server" IsRequired="True" StudentEnrolmentFieldType="DateOfBirth" LabelWidth="200" ClientIDMode="Static" CustomCaption="Date of Birth" />
    </div>
