...
#End Region
    ...
    Public Overrides Sub RenderControl(writer As HtmlTextWriter)
        ...
        Dim itemXF = ctlNationality.Items.FindByValue("XF")

        ctlNationality.Items.Remove(itemXF)
        ctlNationality.Items.Insert(1, itemXF)

        'Dim itemXFR = ctlResidence.Items.FindByValue("XF")

        'ctlResidence.Items.Remove(itemXFR)
        'ctlResidence.Items.Insert(1, itemXFR)


        Dim Item1 = ctlEthnicity.Items.FindByValue("31")
        ...
        Dim Item6 = ctlEthnicity.Items.FindByValue("44")
        ...
        Dim ctlHomeFeeEligibilityID As DropDownList = TryCast(fldHomeFeeEligibilityID.InternalFieldControl, DropDownList)

        Dim fees1 = ctlHomeFeeEligibilityID.Items.FindByValue("1")
        fees1.Text = "Settled status"
        Dim fees2 = ctlHomeFeeEligibilityID.Items.FindByValue("2")
        fees2.Text = "Pre-settled status"
        Dim fees3 = ctlHomeFeeEligibilityID.Items.FindByValue("3")
        fees3.Text = "UK nationals living in the EEA, Switzerland and EU Overseas Territories"
        Dim fees4 = ctlHomeFeeEligibilityID.Items.FindByValue("4")
        fees4.Text = "Family members of UK nationals living in the UK"
        Dim fees5 = ctlHomeFeeEligibilityID.Items.FindByValue("5")
        fees5.Text = "Children of Swiss nationals"
        Dim fees6 = ctlHomeFeeEligibilityID.Items.FindByValue("6")
        fees6.Text = "Children of Turkish Workers"
        Dim fees7 = ctlHomeFeeEligibilityID.Items.FindByValue("7")
        fees7.Text = "The Common Travel Area arrangement with Ireland"
        Dim fees8 = ctlHomeFeeEligibilityID.Items.FindByValue("8")
        fees8.Text = "Irish citizens living in the EEA and Switzerland"
        Dim fees9 = ctlHomeFeeEligibilityID.Items.FindByValue("9")
        fees9.Text = "UK and EU nationals resident in Gibraltar"
        Dim fees10 = ctlHomeFeeEligibilityID.Items.FindByValue("10")
        fees10.Text = "UK nationals resident in the British Overseas Territories"
        Dim fees11 = ctlHomeFeeEligibilityID.Items.FindByValue("11")
        fees11.Text = "Students living in the Crown Dependencies"
        Dim fees12 = ctlHomeFeeEligibilityID.Items.FindByValue("12")
        fees12.Text = "Afghan Citizens Resettlement Scheme"
        Dim fees13 = ctlHomeFeeEligibilityID.Items.FindByValue("13")
        fees13.Text = "Ukraine Family Schemes"

        Dim fees14 = ctlHomeFeeEligibilityID.Items.FindByValue("14")
        If Not IsNothing(fees14) Then
            fees14.Text = "None of the above"
        End If

        'School - Move Not Listed Items To Bottom
        Dim ctlSchoolID As DropDownList = TryCast(fldSchoolID.InternalFieldControl, DropDownList)
        Dim numSchools As Int16 = ctlSchoolID.Items.Count

        Dim notListedHampshire = ctlSchoolID.Items.FindByValue("129")
        ctlSchoolID.Items.Remove(notListedHampshire)
        ctlSchoolID.Items.Insert(numSchools - 1, notListedHampshire)

        Dim notListedOutsideHampshire = ctlSchoolID.Items.FindByValue("130")
        ctlSchoolID.Items.Remove(notListedOutsideHampshire)
        ctlSchoolID.Items.Insert(numSchools - 1, notListedOutsideHampshire)

        Dim notListedOverseas = ctlSchoolID.Items.FindByValue("131")
        ctlSchoolID.Items.Remove(notListedOverseas)
        ctlSchoolID.Items.Insert(numSchools - 1, notListedOverseas)
    ...
    Public Overrides Sub ValidateControl()
        ...
        If RadioButtonListEU.SelectedValue = "0" AndAlso Len(DOEUK.Value) = 0 Then
            ...
            Dim v As New CustomValidator
            v.IsValid = False
            v.ErrorMessage = "Please enter your date of entry into England"
            Me.Page.Validators.Add(v)
