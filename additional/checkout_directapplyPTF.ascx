<%@ Control Language="VB" AutoEventWireup="false" CodeFile="checkout_directapplyPTF.ascx.vb" Inherits="checkout_directapplyPTF" %>
...
<script>
    ...
    <div class="parentaddress">
        ...
        <div class=" form-group">
            <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Contact1Address1" ID="fldAddress1" runat="server" IsRequired="false" LabelWidth="400" CustomCaption="House No./Name and street (Address Line 1)" />
        </div>
        <div class=" form-group">
