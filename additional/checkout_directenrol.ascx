<%@ Control Language="VB" AutoEventWireup="false" CodeFile="checkout_directenrol.ascx.vb" Inherits="checkout_directenrol" %>
...
<div class="form-field-section grey">
    ...
    <div class="form-input">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Tel" ID="StudentEnrolmentField4" runat="server" CustomCaption="Personal Contact Number (Main Number)" IsRequired="true" Placeholder="Please enter 11 digits no spaces" LabelWidth="300" Pattern="^(0[\d]{8,12}|447[\d]{7,11})$" Title="Please enter a valid Telephone Number No spaces" />
    </div>
 ...
 <div class="form-input">
    ...
    <div class=" form-group">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Contact1RelationshipID" ID="StudentEnrolmentField16" runat="server" IsRequired="true" LabelWidth="400" CustomCaption="Relationship to Applicant" />
    </div>


    <div class=" form-group">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Contact1Tel" Placeholder="Please enter 11 digits no spaces" ID="contacttel" runat="server" IsRequired="true" LabelWidth="400" CustomCaption="Contact Main Phone Number" Pattern="^(0[\d]{8,12}|447[\d]{7,11})$" Title="Please enter a valid Telephone Number (0XXXXXXXXXX)" />
    </div>
    ...
    <div class="parentaddress">
        ...
        <div class=" form-group">
            <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Contact1Address3" ID="fldAddress3" runat="server" IsRequired="false" LabelWidth="400" CustomCaption="Town / City" />
        </div>
        <div class=" form-group">
            <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Contact1Address4" ID="fldAddress4" runat="server" IsRequired="false" LabelWidth="400" CustomCaption="County" />
        </div>
        <div class="form-input">
    ...
    <div class="disFields">
        <div class="form-input">
            <cc1:StudentEnrolmentField runat="server" ID="fldDisabilityCategory1ID" CustomCaption="Main Disability/Learning Difficulty" StudentEnrolmentFieldType="DisabilityCategory1ID" />
        </div>
        <div class="form-input">
            <cc1:StudentEnrolmentField runat="server" ID="fldDisabilityCategory2ID" CustomCaption="Please identify any secondary Disabilities / Learning Difficulties" StudentEnrolmentFieldType="DisabilityCategory2ID" LabelWidth="450" />
        </div>
    ...
    <div class="displaynone">
        ...
        <%--<cc1:StudentEnrolmentField StudentEnrolmentFieldType="HasEducationHealthCarePlan" ID="fldHasEducationHealthCarePlan" runat="server" LabelWidth="400" />--%>
    ...
    <div class="crcFields">
        ...
        <p>
            South Hampshire College Group is keen to support all students to help them succeed. For some careers you will need to declare all criminal convictions including those that are spent. Doing this will not necessarily stop you being offered a place on the course. If you are unsure about what to declare then please seek advice from Student Services (you do not need to give your name) or the National Careers Service.
...
Please note that failing to complete this section or providing false information may lead to your application/ enrolment being withdrawn. Any information you provide the College Group in relation to criminal convictions will only be disclosed to third parties if this is necessary in the interests of the safety and welfare of other students or staff.
    ...
    <h2 class="app-title">Prior Attainment</h2>

    <cc1:StudentEnrolmentField ID="fldPrior" runat="server" CustomCaption="What is your highest level of Qualification?"
    ...
    <table class="HighestQualificationGuidance">
        <tbody>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p><strong>Academic Qualification Equivalent</strong></p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>Qualifications at Entry Level including Literacy, Numeracy, ESOL, Key Skills, Functional Skills, Essential Digital Skills</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>Qualification at Level 1 including GCSE/O Level (at grades D-G/3-1 or fewer than 5 at grades A-C/9-4), 1 AS Level, Foundation 14-19 Diploma, Introductory Diploma</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>Qualifications at Level 2 including Functional Skills, ESOL, Technical Awards</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>GCSE/O Level (5 or more GCSEs grades A*-C/9-4), 2 or 3 AS Levels, 1 A Level, Higher 14-19 Diploma, QCF Diploma, NVQ, GNVQ Intermediate</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>Qualifications at Level 3 including Core Maths, components of international baccalaureate, vocational and technical qualifications not listed as Full Level 3</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>2 or more A Levels, 4 or more AS Levels, QCF Diploma, Access to HE, Advanced 14-19 Diploma, GNVQ Advanced, NVQ, T-Level</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>QCF/RQF qualifications at Level 4, Higher National Certificate (HNC), Certificates of Higher Education</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>QCF/RQF qualifications at Level 5, Higher National Diploma (HND), Foundation degree</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>QCF/RQF qualifications at Level 6, Bachelor&rsquo;s degree, graduate certificates and diplomas</p>
                </td>
            </tr>
            <tr>
                <td width="113">
                ...
                <td width="488">
                    <p>QCF/RQF qualifications at Level 7+, Master&rsquo;s degree, postgraduate certificates and diplomas, Doctorate</p>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="form-input">
        <cc1:StudentEmploymentHistoryField StudentEmploymentHistoryFieldType="EmploymentStatusID" ID="Field_EmploymentStatusID" runat="server" IsRequired="True" CustomCaption="Employment Status" ClientIDMode="Static" ExcludedIDValues="98" />
    </div>
    ...
    <br />
    <div class="form-input">
        <p>Are you in receipt of any benefits?</p>
        <cc1:StudentEmploymentHistoryField StudentEmploymentHistoryFieldType="BenefitStatusIndicatorID" ID="StudentEmploymentHistoryField2" runat="server" IsRequired="false" LabelWidth="300"
            CustomCaption=" " />
    </div>
<%--    <div class="form-input">
        <p>Are you in receipt of any benefits?</p>
        <cc1:StudentEmploymentHistoryField StudentEmploymentHistoryFieldType="PreviouslyInFTEducation" ID="StudentEmploymentHistoryField3" runat="server" IsRequired="false" LabelWidth="300"
            CustomCaption=" " CustomFieldType="TickBox" />
    </div>--%>
