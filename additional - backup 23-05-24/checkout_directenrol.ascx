...
<div class="form-field-section grey">
  ...
  <%--  <div class="form-input">
    ...
    <div class="form-input">
        <p>First Forename (First Name - Legal Name)</p>
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="FirstForename" ID="StudentEnrolmentField1" runat="server" IsRequired="true" LabelWidth="0" CustomCaption="First Name" />
    </div>

    <div class="form-input">
        <p>Known As (Do not input nicknames - this is the name that will appear on registers)</p>
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="KnownAs" ID="StudentEnrolmentField11" runat="server" IsRequired="false" LabelWidth="0" CustomCaption="Middle Name(s)" />
    </div>

    <div class="form-input">
        <p>Surname (Last name) - Legal Family Name</p>
...
<br/>
    ...
    <div class="form-input">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="MobileTel" ID="StudentEnrolmentField2" runat="server" CustomCaption="Mobile" IsRequired="true" LabelWidth="500" Pattern="(07\d{9}|447\d{9})$" Title="Please enter a valid Mobile Telephone Number No spaces" />
    </div>
...
<script>
    ...
    <div id="Under19" runat="server" visible="false">
...
<script>
    ...
    <div class="form-input">
        <span class="textfieldlabelrequired">Are you a UK or Irish citizen and been an ordinary resident in the UK or Ireland for the last 3 years?</span>
...
music grades 1, 2 and 3</td>
            ...
            <tr>
                <td>Full Level 2</td>
                <td>GCSE/O Level GCSE grades 9-1 or Grades A* - G, 1 AS Levels (for AS qualifications regulated before 1 September 2015), CSE Grades 2-5, any other level 2 Award or any other level 2 qualification not listed as full level 2
                </td>

            </tr>
            <tr>
                <td>Full Level 3</td>
                <td>1 A Levels, 3  or less AS Levels (for AS qualifications regulated before 1 September 2015), QCF Certificate Level 3 at Level 3 which is less than 30 credits, any other level 3 award or any other level 3 qualification not listed as full level 3</td>
