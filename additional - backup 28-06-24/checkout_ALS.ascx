...
<div class="form-field-section grey" id="divmain" runat="server">
    ...
    <div class="form-input">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="FirstForename" Placeholder="As it appears on legal documents i.e. Birth Certificate, Passport etc" ID="StudentEnrolmentField1" runat="server" IsRequired="true" LabelWidth="300" CustomCaption="First Name" />
    </div>
    <div class="form-input">
