...
<div class="slidingDiv">
    ...
    <%-- <div class=" form-group">
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="Enquiry" ID="StudentEnrolmentFieldEnquiry" runat="server" IsRequired="false" 
            LabelWidth="200" CustomFieldType="Other" HTML5InputType="text" Placeholder="If you cant find it in the list, please tell us which course / events you are interested in" />
    </div>--%>

    </div>
<%--    <div class=" form-group">
       
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="EnquiryUserDefined6" ID="StudentEnrolmentField4" runat="server" IsRequired="true" LabelWidth="200"
            CustomCaption=" What time do you expect to arrive (approx)?" CustomFieldType="Time" />
    </div>--%>
  ...
  <%--   <div class=" form-group">
        ...
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="SchoolID" ID="StudentEnrolmentField5" runat="server" IsRequired="false" LabelWidth="400" ExcludedIDValues="209,2927,638,3432,182463,182635,1490,1489,184225,2793,48" 
            CustomCaption=" Current School/ College (16-18 year olds only)" />
    </div>--%>
    ...
    <br />
      ...
      <p class="textfieldlabelrequired">How did you find out about college?</p>
        ...
        <div class=" form-group">
      <p class="textfieldlabelrequired">I am currently...</p>
        <cc1:StudentEnrolmentField StudentEnrolmentFieldType="EnquiryUserDefined1" ID="StudentEnrolmentField1" runat="server" IsRequired="false" LabelWidth="0"
            CustomCaption="I am currently" CustomFieldType="Lookup" />
    </div>
