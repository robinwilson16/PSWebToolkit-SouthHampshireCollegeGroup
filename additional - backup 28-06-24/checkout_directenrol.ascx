 ...
 <div class="form-input">
    ...
    <div id="Under19" runat="server" visible="true">
        ...
        <div class="parentaddress2">
            ...
            <div class=" form-group">
                <p class="textfieldlabelrequired">House No./Name and street (Address Line 1)</p>
    ...
    <div class="disFields">
        <div class="form-input">
            <p class="textfieldlabelrequired">Main Disability/Learning Difficulty</p>
            <cc1:StudentEnrolmentField runat="server" ID="fldDisabilityCategory1ID" CustomCaption="Main Disability/Learning Difficulty" StudentEnrolmentFieldType="DisabilityCategory1ID" LabelWidth="0" />
        </div>
        <div class="form-input">
            <cc1:StudentEnrolmentField runat="server" ID="fldDisabilityCategory2ID" CustomCaption="Please identify any additional Disabilities / Learning Difficulties" StudentEnrolmentFieldType="DisabilityCategory2ID" LabelWidth="450" />
        </div>
...
Please note that failing to complete this section or providing false information may lead to your application/ enrolment being withdrawn. Any information you provide the College Group in relation to criminal convictions will only be disclosed to third parties if this is necessary in the interests of the safety and welfare of other students or staff.
    ...
    <div class="form-input">
        <p class="textfieldlabelrequired">Employment Status</p>
        <cc1:StudentEmploymentHistoryField StudentEmploymentHistoryFieldType="EmploymentStatusID" ID="Field_EmploymentStatusID" runat="server" IsRequired="True" LabelWidth="0"
    ...
    <div class="Employedfields" id="Employedfields" runat="server">
        ...
        <br />
     <%--   <div class="form-input">
            <span class="textfieldlabelrequired">Start date (If employed)</span>
            <cc1:StudentEmploymentHistoryField StudentEmploymentHistoryFieldType="DateFrom" ID="datepicker1" runat="server" IsRequired="false" LabelWidth="300"
                CustomCaption=" " />
        </div>--%>
        ...
        <p class="textfieldlabelrequired">Are you earning less than £30,000 (If employed)</p>
              <cc1:StudentEnrolmentField runat="server" ID="StudentEnrolmentField6" CustomCaption="Earning less than £30k" StudentEnrolmentFieldType="StudentDetailUserDefined7" LabelWidth="0" CustomFieldType="Lookup" />
...
<%--    <div class="form-input">
    ...
    <p>
        Please familiarise yourself with our Data Protection Policy and GDPR Pack which will provide you with further information about use of and access to your personal data, and details of organisations with whom we regularly share data:
